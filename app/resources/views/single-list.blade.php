            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="/laundries/editlaundry/{{$laundry->id}}" method="POST" class="edit-laundry-details">
                            @csrf
                            @method('PUT')
                            ...
                            <input type="number" name="price" id="" value="{{$laundry->price * $laundry->weight}}.00"><br><br>
                            ...
                            <input type="number" name="weight" id="" value="{{$laundry->weight}}"><br><br>

                            <label for="">Quantity</label><br>
                            <input type="number" name="que_number" id="" value="{{$laundry->que_number}}"><br><br>
                            <label for="">Status</label><br>
                            <select name="status" id="">
                                <option value="{{$laundry->status}}">Choose</option>
