...
<center>
        <div class="admin-dashboard-container">
            <div class="laundry-management-list">
                ...
                <form action="/customers/place-order" method="GET" class="search-single-laundry-comp">
                    @csrf
                ...
                <table>
                    ...
                    <tr>
                        ...
                        @endif
                        <td>
                            <a href="/customers/my-list/{{$laundry->id}}"><i class="fa fa-eye" style="color: #0000FF;"></i></a>
                        </td>
                    </tr>
                ...
                <form action="/laundries" method="POST" class="add-laundry-new-data">
                    ...
                    <input type="hidden" name="customer_name" id="" value="{{Auth::guard('customer')->user()->name}}">
